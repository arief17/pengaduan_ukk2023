    ...
    <div class="container"> 
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <h3>Form Register Masyarakat - Pengaduan Masyarakat</h3>
                    <form action="save_register.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nomor Telphone/HP</label>
                    ...
                    <a href="../index.php" class="mt-5" style="text-decoration: no
                    ;">Kembali ke Login</a>
                </div>
            </div>
            <div class="col-sm-4"></div>
